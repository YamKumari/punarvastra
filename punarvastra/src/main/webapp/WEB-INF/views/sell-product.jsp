...
<main class="narrow">
    ...
    <form method="post" action="${pageContext.request.contextPath}/sell"
        ...
        <label>Size <input type="text" name="size" placeholder="S, M, L, XL, Free..." required/></label>
        ...
        <label>
            Photo (jpg/png, max 5MB - optional)
            <input type="file" name="image" accept=".jpg,.jpeg,.png"/>
            <small style="display:block; margin-top:5px; color:#666;">
                If no photo is uploaded, a placeholder image will be used.
            </small>
        </label>
